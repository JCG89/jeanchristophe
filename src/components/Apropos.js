                        ...
                        <div className="row">
                              ...
                              <div className="col-lg-6 col-xm-12">
                                    ...
                                    <p className="parag">
                                          ...
                                          Je suis inscrit à l’un des meilleurs institut supérieur en ligne qu’est OpenClassrooms pour une formation en alternance dans l’optique de valider un titre de niveau six (Bac+ 3/4) car le numérique est en constante évolution et que l’apprentissage ne s'arrête jamais .
