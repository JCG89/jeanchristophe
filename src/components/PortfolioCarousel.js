...
const PortfolioCarousel = () => {
      return (
            <Carousel className="carousel">
                  <>
                        <div>
                              <img src={avatar1} alt=" projet-symfony" className="portfolio-tof" />
                              <h3 className="jc"><a href="https://github.com/christophegomis89/awara-boutique" id="jc">AWARA-BOUTIQUE</a></h3>
                  ...
                  <>
                        <div>
                              ...
                              <h3 className="jc"> <a href="https://github.com/christophegomis89/cv-jean-christophe-gomis" id="jc">MON PORTFOLIO</a> </h3>
                  ...
                  <>
                        <div>
                              ...
                              <h3 className="jc"> <a href="https://gsportnews.fr" id="jc">Gsportnews.fr</a></h3>
                              <p className="text"> Projet réalisé avec REACT JS. Ce nom de domaine est dédié à mon blog  d'information sportif , mais heberge temporairement mon portfolio qui deviendra Jean Christophe.com ou .fr</p>
                  ...
                  <>
                        <div>
                              ...
                              <h3 className="jc"> <a href="https://smblsemedo.com" id="jc">site vitrine smbl semedo</a></h3>
